...
public:
	...
	~UI();
	void draw(Objeto* obj);
	void real_draw(Objeto* obj, cairo_t *cr, GtkWidget *widget);
	void pintar_fundo(double red, double green, double blue, double alpha);
