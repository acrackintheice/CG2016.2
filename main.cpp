...
int main (int argc, char *argv[])
{
  ...
  Wireframe* pol = new Wireframe(cube_points, cube_edges, "Cube", new Color(0,0,0,1), new Color(1,1,1,1), false);
  ...
  Wireframe* w = new Wireframe(wireframe_points, wireframe_edges, "Wireframe", new Color(0,0,255,1), new Color(1,1,1,1), false);
